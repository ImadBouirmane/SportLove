        ...
        child: StreamBuilder<List<AnnoncesRecord>>(
          ...
          builder: (context, snapshot) {
            ...
            return Column(
              ...
              children:
                  List.generate(columnAnnoncesRecordList.length, (columnIndex) {
                final columnAnnoncesRecord =
                    columnAnnoncesRecordList[columnIndex];
                return Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0, 0, 0, 10),
                  child: FutureBuilder<List<AnnoncesRecord>>(
                    future: AnnoncesRecord.search(
                      term: columnAnnoncesRecord.titre,
                      location: columnAnnoncesRecord.userLocation,
                    ),
                    builder: (context, snapshot) {
                      // Customize what your widget looks like when it's loading.
                      if (!snapshot.hasData) {
                      ...
                      List<AnnoncesRecord> cardAnnoncesRecordList =
                          snapshot.data;
                      return InkWell(
                        onTap: () async {
